            ...
            <div className="relative flex-1 content-right">
              ...
              <form className="grid grid-cols-1 gap-5 p-4 pb-10 bg-white rounded-lg shadow-md field-group md:grid-cols-2 xl:grid-cols-3">
                ...
                <div className="field">
                  ...
                  <input type="text" id="issued" placeholder="" disabled {...register("issued")} />
                </div>
                <div className="field">
                  <label htmlFor="expires">Expires</label>
                  <input type="text" id="expires" placeholder="" disabled {...register("expires")} />
                </div>
                <div className="field">
                  <label htmlFor="documentNumber">Document Number</label>
                  <input type="text" id="documentNumber" placeholder="" disabled {...register("documentNumber")} />
                </div>
              </form>
            </div>
          </div>
